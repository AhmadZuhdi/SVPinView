...
public class SVPinView: UIView {
    ...
    public var attributedPlaceholderAttributes: [NSAttributedString.Key: Any] = [:]
...
extension SVPinView : UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout
{
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (self.attributedPlaceholderAttributes.count > 0) {
            textField.attributedPlaceholder = NSAttributedString(string: String(Array(self.placeholder)[indexPath.row]), attributes: self.attributedPlaceholderAttributes)
        }
